"""
en el que esta fuera del plano no logre hacer que A me diera 500
por lo tanto use 1000 y funciono al igual que por ese motivo mis cantidades
debian ser mayores para que salgan del plano
